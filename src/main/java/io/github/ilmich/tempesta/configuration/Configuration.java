...
public class Configuration {
	...
	/**
	 * The package under which <code>RequestHandler</code> implementations are to be
	 * found, for example "org.apache.awf".
	 */
	 ...
	 */
	public Map<String, HttpRequestHandler> getHandlerMap() {
		return handlerMap;
	}
	 ...
	 */
	public Configuration addHandler(String path, HttpRequestHandler handler) {
		handlerMap.put(path, handler);
		return this;
	}

	/**
	 * Retrieve the package under which <code>RequestHandler</code> implementations
	 * are to be found, for example "org.apache.awf".
	 * 
	...
	/**
	 * Set package under which <code>RequestHandler</code> implementations are to be
	 * found, for example "org.apache.awf".
	 * 
	...
	/**
	 * Retrieve directory from which static content should be retrieved. Defaults to
	 * the value of {@link #DEFAULT_STATIC_DIRECTORY} where empty or
	 * <code>null</code>.
	 * 
	...
	public Configuration addHandlers(Map<String, HttpRequestHandler> handlers) {
