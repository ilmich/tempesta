...
public class HttpRequestParser {
    ...
    /**
     * Parse the data in the given buffer as an Http request. It handles
     * segmented buffer when the given request is not null.
     * 
     * @param buffer
     *            ByteBuffer containing data to parse
     * @param result
     *            null if it's a new request or the incomplete request
     * @return new HttpRequestImpl if result is null representing a complete or
     *         incomplete request on error, it will return a
    ...
    /**
     * Fill's the body buffer with the data retrieved from the given buffer
     * starting at buffer position and copying given size byte.<br/>
