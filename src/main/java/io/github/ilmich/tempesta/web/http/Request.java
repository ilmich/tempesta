...
public interface Request {
	...
	/**
	 * Returns a map of all parameters where each key is a parameter name, linked
	 * value is a Collection of String containing all known values for the
	 * parameter. When the parameter has no value, the collection will be empty.
	 * 
	 ...
	 * no values are found and empty collection is returned.
	 */
	 ...
	 * 
	 * @see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec8.html">HTTP/1.1
